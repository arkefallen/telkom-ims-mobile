...
import 'package:mobile_umkm/pages/Transaksi/transaksi_out.dart';
import 'package:mobile_umkm/theme.dart';

class AddTransaksiOut extends StatefulWidget {
  List? list;
  int index;
  AddTransaksiOut({required this.index, this.list});

  @override
  State<AddTransaksiOut> createState() => _AddTransaksiOutState();
}

class _AddTransaksiOutState extends State<AddTransaksiOut> {
  DatabaseHelper databaseHelper = new DatabaseHelper();

  late TextEditingController _namaInv;
  late TextEditingController _jumlahOut;
  ...
  void initState() {
    ...
    _jumlahOut = new TextEditingController(
            ...
            OutlinedButton(
              ...
              onPressed: () {
                databaseHelper.editTransaksi(
                    ...
                    _jumlahOut.text.trim());
                Navigator.of(context).push(new MaterialPageRoute(
                  builder: (BuildContext context) => new TransaksiOut(),
                ));
              },
              child: Text(
                "SIMPAN",
