...
class PreviewTrx extends StatefulWidget {
  PreviewTrx({Key? key, this.index, this.list}) : super(key: key);
  List? list;
  int? index;

  @override
  State<PreviewTrx> createState() => _PreviewTrxState();
}

class _PreviewTrxState extends State<PreviewTrx> {
